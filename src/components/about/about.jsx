      ...
      <div className='about__container grid'>
        ...
        <div className="about__data grid">
          <div className="about__info">
            ...
            Welcome! I'm an enthusiastic, aspiring Software Developer who yearns working on fresh initiatives and meeting new individuals. I've worked as a software developer for a year, designing & developing full stack applications.
            ...
            <div className="spacer__bottom">
              <a target="_blank" rel="noopener noreferrer" href="https://drive.google.com/file/d/1XlJqcS0ZXlV3JRl0oMJhIbtJyQ3k0Qok/view?usp=sharing" className="btn">View Resume</a>
            </div>
          </div>
